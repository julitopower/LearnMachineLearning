...
def conv2d_block(units, input_layer, residual=False):
    ...
    return keras.layers.MaxPooling2D((2, 2), strides=(2, 2), padding='same')(ac2)

def vgg():
    input_1 = keras.layers.Input(shape=(32, 32, 3))
    cv_block_1 = conv2d_block(64, input_1, True)
    cv_block_2 = conv2d_block(128, cv_block_1, True)
    cv_block_3 = conv2d_block(256, cv_block_2, True)
